        ...
        <div className="absolute inset-0 flex items-center p-14 z-10">
          <div className="flex flex-col md:flex-row gap-10 items-center w-full">
            ...
            <div className="flex-1">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-4 drop-shadow-xl">{movie.title}</h1>
              ...
              <div className="flex items-center gap-4 mb-10">
                <Link to={`/player?type=movie&id=${movie.id}`} className="bg-white hover:bg-gray-200 text-black px-8 py-3.5 rounded-full font-bold flex items-center gap-2 transition-all hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.2)]">
